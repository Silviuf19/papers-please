defmodule School.Logic do
  ...
  def validate_rule4(%{type: :parcel, weight: weight, shipping_class: shipping_class})
      when weight > 5000 do
  ...
  def validate_rule7(%{destination: :eu, shipping_class: shipping_class})
  ...
  def validate_rule9(%{shipping_class: :standard}),
    do: {:invalid, "standard shipping is only available for domestic package under 2000g"}

  def validate_rule9(_package), do: {:valid, "rule9"}
